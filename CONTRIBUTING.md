...
```
git clone git@github.com:UCL-CyberPhysicalSystems/fosdem2026.git
```

## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/UCL-CyberPhysicalSystems/fosdem2026/issues/new
